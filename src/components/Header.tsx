...
const Header = ({ activeTab }: HeaderProps) => {
  return (
    <div id='header' className='h-12 border-b border-y-slate-600 flex items-center'>
      ...
      >
        <div id='activeButton' className='w-16 text-center cursor-pointer hover:text-slate-50'>
          Active
        </div>
        <div id='allButton' className='w-16 text-center cursor-pointer hover:text-slate-50'>
          All
        </div>
      </div>
    </div>
